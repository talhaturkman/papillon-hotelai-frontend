...
class GeminiService {
    constructor() {
        ...
        console.log(`��� Gemini API initialized: ${this.model} (FIXED)`);
        if (!this.apiKey) {
...
Answer guests' questions naturally. Only ask about hotel when hotel-specific information is needed. ALL RESPONSES MUST BE IN ENGLISH.`
            ...
            console.log(`��� Using ${detectedLanguage} system prompt for Gemini (FIXED)`);
            ...
            if (response.data && response.data.candidates && response.data.candidates[0]) {
                ...
                console.log(`✅ Gemini API Success (FIXED): Response length ${aiResponse.length} chars`);
                return {
                    success: true,
                    response: aiResponse
                };
